      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/loja/catalogo" className="flex items-center gap-3">
            ...
            <span className="text-2xl font-display font-bold text-velare-gold tracking-wider">VELARE</span>
          </Link>

          <button onClick={onCartClick} className="relative p-2 rounded-lg text-velare-text-muted hover:text-velare-text hover:bg-velare-panel transition-colors">
